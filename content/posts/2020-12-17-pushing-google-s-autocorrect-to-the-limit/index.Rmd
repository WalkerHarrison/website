...
[_**Don't like/know/care about R? Click here to skip to the punchline.**_](#skip1)
...
(Note that the code to produce the graph is lengthy but not particularly interesting so I've hidden it, although it is available in [the original .Rmd](https://github.com/WalkerHarrison/website/blob/main/content/posts/2020-12-17-pushing-google-s-autocorrect-to-the-limit/index.Rmd){target="_blank"}.)
...
[_**Still don't like/know/care about R? Click here to skip to the (next) punchline.**_](#skip2)
...
(Again the graphing code is hidden. Again it is available in [the original .Rmd](https://github.com/WalkerHarrison/website/blob/main/content/posts/2020-12-17-pushing-google-s-autocorrect-to-the-limit/index.Rmd){target="_blank"}.)
